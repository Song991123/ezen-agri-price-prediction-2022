...
'''
cols_all = ['date','Tmin','Tmax','Tmean','Hmax','price','Tmin_s','Tmax_s','Tmean_s','Hmax_s']
cols_get = ['date','Tmean_s','Tmin_s','Tmax_s','price']
cols_cut = ['date','Tmean','Tmin','Tmax','price']
